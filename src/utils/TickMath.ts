/// @dev This is a port of the tick math from Uniswap V3.
/// @see https://github.com/Uniswap/v3-periphery/blob/main/contracts/libraries/TickMath.sol
...
export class TickMath {
    ...
    static getSqrtRatioAtTick(tick: number): bigint {
      ...
      return (ratio >> 32n) & 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFn; // Q128.128 → Q64.96
    }
  }