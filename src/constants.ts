...
export const ADDRESSES: { address: string; LPAMOUNT: string }[] = [
    { address: "0xC76F4c819D820369Fb2d7C1531aB3Bb18e6fE8d8", LPAMOUNT: parseEther("50").toString() },
    { address: "0x839FdB6cc98342B428E074C1573ADF6D48CA3bFd", LPAMOUNT: parseEther("50").toString() },
    { address: "0x495eea66B0f8b636D441dC6a98d8F5C3D455C4c0", LPAMOUNT: parseEther("1000000").toString() }, //shib
    { address: "0x8ed7d143Ef452316Ab1123d28Ab302dC3b80d3ce", LPAMOUNT: parseEther("0.14").toString()}, // weth
    { address: "0xeCe898EdCc0AF91430603175F945D8de75291c70", LPAMOUNT: parseEther("500000000").toString() } //damn
];
